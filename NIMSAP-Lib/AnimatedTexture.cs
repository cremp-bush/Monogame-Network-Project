...
// TODO: Заменить сэмпл своей реализацией
/// <summary>
...
public class AnimatedTexture : Texture
{
    ...
    public Texture2D GetTexture() => myTexture;
    
    public Rectangle GetRectangle() => new Rectangle(myTexture.Width / frameCount * frame, 0, myTexture.Width / frameCount, myTexture.Height);

    public AnimatedTexture Load(ContentManager content, string asset, int frameCount, int framesPerSec)
    {
